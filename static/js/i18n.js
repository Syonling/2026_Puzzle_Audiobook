...
const messages = {
    zh: {
        ...
        "audio.effectsControls": "素材音效处理", "audio.selectClip": "选择素材音频后添加效果", "audio.fadeIn": "淡入", "audio.fadeOut": "淡出", "audio.reverb": "空间", "audio.echo": "回声", "audio.effectUndo": "撤销", "audio.effectReset": "还原",
