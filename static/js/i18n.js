...
Object.assign(messages.ja, {
    ...
    "assistantTools.label":"制作支援ツール","assistantTools.tabs":"支援ツールを選択","assistantTools.ai":"AIアシスタント","assistantTools.audio":"素材サウンド",
    "audioPicker.eyebrow":"Icon Audio","audioPicker.heading":"素材サウンド","audioPicker.options":"素材音声の候補","audioPicker.iconAndAudio":"{icon}・現在：{audio}","audioPicker.silent":"無音","audioPicker.switching":"音声を切り替えています…","audioPicker.failed":"音声の切り替えに失敗しました","audioPicker.empty":"音声付きのキャンバス素材を選択すると、ここで音声を変更できます。",
...
Object.assign(messages.en, {
    ...
    "assistantTools.label":"Creative assistant tools","assistantTools.tabs":"Choose an assistant tool","assistantTools.ai":"AI Assistant","assistantTools.audio":"Asset Sound",
    "audioPicker.eyebrow":"Icon Audio","audioPicker.heading":"Asset Sound","audioPicker.options":"Alternative asset audio","audioPicker.iconAndAudio":"{icon} · Current: {audio}","audioPicker.silent":"No Sound","audioPicker.switching":"Switching audio…","audioPicker.failed":"Failed to switch audio","audioPicker.empty":"Select a canvas asset with sound to change its audio here.",
