...
def canvas_design_prompt(language: Language) -> str:
    return (
        ...
        "- When background_audio_enabled is true, select selected_background_audio_key as one exact audio_key belonging to background_key in available_audio_options, and return a useful background_start_offset_seconds and at most two background_effect_keys.\n"
