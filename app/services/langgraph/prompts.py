...
def sound_analysis_prompt(language: Language) -> str:
    return (
        ...
        "- Every audio_suggestions[*].asset_key must be a story-relevant retained or recommended icon, and selected_audio_key must belong to available_audio_options for that asset_key.\n"
