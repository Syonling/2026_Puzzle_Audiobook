...
BACKGROUND_DESCRIPTIONS: dict[str, str] = {
    ...
    "lighthouse_interior_background": "the dim enclosed interior of a lighthouse tower with curved cylindrical stone walls, a wide open circular stone floor, a single warm lantern glow, and deep shadowed corners; strictly no windows, doors, sea, sky, coast, or outdoor scenery",
}
